...
app.layout = html.Div([
    ...
    html.H1("Automobile Statistics Dashboard", style={'text-align':'center','color':'#000080', 'bold':True}),
    html.Div([
    ...
    html.Div([html.Div(id='output-container', className='chart-grid', style={'display': 'flex', 'background-color':""})])
])
